...
const Header = () => {
  ...
  return (
    <div className="wrap xxl:bg-center h-[700px]">
      <div className="max-w-[1280px] flex content-between flex-col h-[700px] z-50 pt-24 mx-auto">
        ...
        <div className="flex sm:grid mt-20 sm:grid-cols-1 gap-5 xxl:mx-[50px] md:flex lg:justify-center items-center text-white pb-10">
